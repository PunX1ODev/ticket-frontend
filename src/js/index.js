(() => {
  ...
  let ticketNumbers = document.getElementById("ticketNumbers");
  let textTotal = document.getElementById("total");
  let seleccionadas = document.getElementById("seleccionadas");
  ...
  //#region funciones
  const total = () => {
    let total = parseInt(ticketNumbers.textContent) * 140000;
